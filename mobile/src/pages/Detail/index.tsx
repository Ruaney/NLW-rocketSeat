...
const Detail = () => {
    ...
    function handleComposeWhatsapp(){
      Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Tenho interesse sobre coleta de gads`)
    }
    if(!data.point){
      return null;
    }
    ...
    <>
        <View style={styles.container}>
            ...
            <Text style={styles.addressContent}> {data.items.map(item=>item.tittle).join(', ')}</Text>
